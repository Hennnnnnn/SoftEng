        ...
        <div class="mb-4 row form-group">
            ...
            <div class="col-6">
                <input type="text" name="productName" id="productName"
                    class="mt-1 p-2 border rounded-md w-full form-control" value="{{ old('productName') }}">
                @error('productName')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="mb-4 row form-group">
            ...
            <div class="col-6">
                <textarea name="productDescription" id="productDescription" rows="4"
                    class="mt-1 p-2 border rounded-md w-full form-control">{{ old('productDescription') }}</textarea>
        ...
        <div class="mb-4 row form-group">
            ...
            <div class="col-6">
                <input type="text" name="productPrice" id="productPrice"
                    class="mt-1 p-2 border rounded-md w-full form-control" value="{{ old('productPrice') }}">
                @error('productPrice')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
