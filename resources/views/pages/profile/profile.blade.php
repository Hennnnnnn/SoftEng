     ...
     <div class="row">
        ...
        <div class="row my-5">
            <div class="col-md-6 col-12 text-center" >
                <div class="row">
                    <div class="col-12">
                            <img src="{{ asset('upload/profile_images/' . Auth::user()->image) }}" alt="Profile Image"
                                class="rounded-circle" width="250" height="250" onerror="this.src='default_image_path.jpg';">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <p class="h6">{{ $followingCount }} <span class="divider mx-5">|</span> {{ $followersCount }}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-12">
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        <span class="h4">Telephone Number:</span> <span class="h6">{{ Auth::user()->telephone_number ?? '-' }}</span> 
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-12">
                        <span class="h4">Address:</span> <span class="h6">{{ Auth::user()->address ?? '-' }}</span> 
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-12">
                        <span class="h4">Gender:</span> <span class="h6">{{ Auth::user()->gender ?? '-' }}</span> 
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-12">
                        <span class="h4">Total Points:</span> <span class="h6">{{ Auth::user()->points }}</span> 
                    </div>
                </div>
            </div> 
        </div>
