        ...
        <div class="col-12 col-md-6 align-middle">
            <div class="row border-bottom border-3 border-main-dark-green px-1 py-4">
                ...
                <div class="col-7 d-flex align-items-end pb-3">
                    <form action="{{ route('discussion.store') }}" method="POST" class="w-100 d-flex">
                        @csrf <!-- Tambahkan token CSRF untuk keamanan -->
                        <input type="text" name="content" class="form-control border-0 no-border flex-grow-1" placeholder="Start A Discussion..." required>
                        
                        <button type="submit" class="rounded-3 btn bg-main-dark-green shadow text-center align-middle text-light font-weight-bold px- ml-2">
                            Post
                        </button>
                    </form>
                </div>
                ...
                <div class="col-12">
                    @foreach ($postList as $item)
                        <div class="px-1 py-4 row border-bottom border-3 border-main-dark-green">
                            <div class="col-2">
                                <img src="{{ asset('upload/profile_images/' . $item->users->image) }}" class="img-circle">
                            </div>
                            <div class="col-9">
                                <div class="col-12">
