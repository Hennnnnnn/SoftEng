                    ...
                    @foreach ($postList as $item)
                        <div class="px-1 py-4 row border-bottom border-3 border-main-dark-green">
                            ...
                            <div class="col-9">
                                <div class="col-12">
                                    ...
                                    @else
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-person-plus-fill mb-1" viewBox="0 0 16 16">
                                            <path
                                ...
                                <div class="col-12">
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum nesciunt aliquid
                                    eum sequi! Numquam tempora nulla sint eius illo ullam autem reiciendis iusto. Quidem
                                    eius ratione quis ad, incidunt accusamus dignissimos quisquam earum quas veniam
                                    illum possimus voluptatum, enim dicta perspiciatis natus eveniet cum ipsam, officiis
                                    et optio! Non tempora tempore vitae nihil unde est recusandae consequuntur rem
                                    dolores tenetur aperiam nobis, adipisci sequi natus accusantium quidem nemo odio
                                    optio. Nihil architecto sunt quae nesciunt temporibus, quaerat, enim nemo incidunt
                                    dolorum tenetur dicta veritatis reprehenderit recusandae non placeat laudantium
                                    quam, nam provident deserunt quibusdam! Voluptas ut ipsum sint! Totam, dolores?
                                </div>
